<template>
    <WindowToolbarComponent>
        <TabsComponent triggersContainerClass="border-gray-300 dark:border-gray-600 border-b px-4 bg-gray-50 dark:bg-slate-800">
            <template #triggers>
                <TabComponent class="px-3 py-1 mr-2">
                    File
                </TabComponent>
                <TabComponent class="px-3 py-1 mr-2">
                    Edit
            ...
            <template #targets>
                <TargetComponent class="flex flex-wrap px-2 sm:px-4 py-1 bg-gray-50 dark:bg-slate-800 border-gray-300 dark:border-gray-600 border-b text-gray-700 dark:text-gray-300">
                    ...
                    <div role="menuitem">
                        <ToolbarButtonComponent @click="$notebook.closeWindow();" title="Exit">
                ...
                <TargetComponent class="flex flex-wrap px-2 sm:px-4 py-1 bg-gray-50 dark:bg-slate-800 border-gray-300 dark:border-gray-600 border-b text-gray-700 dark:text-gray-300">
                    <div role="menuitem">
                        <ToolbarButtonComponent @click="$window.toggleToolbar();" :title="toolbar ? 'Toolbar on' : 'Toolbar off'">
                            <i class="fa-solid fa-screwdriver-wrench" :class="{'text-indigo-500 dark:text-indigo-600': spellcheck}"></i>
                        </ToolbarButtonComponent>
                    </div>
                    <div role="menuitem">
