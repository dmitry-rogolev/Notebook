<template>
    <WindowComponent>
        ...
        <EditableComponent 
            ref="contenteditable"
            class="flex-auto px-3 sm:px-4 md:px-5 py-3 bg-gray-50 dark:bg-slate-800 text-gray-800 dark:text-gray-200 text-base focus-visible:outline-none whitespace-pre-wrap overflow-auto" 
            :style="{tabSize: 4}"
            autofocus
            v-model="note.text"
            />
